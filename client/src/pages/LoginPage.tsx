      ...
      <div className="flex-1 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative bg-[#010103]">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="space-y-4 mb-8">
            <button className="w-full py-3.5 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 transition-colors flex items-center justify-center gap-3 text-sm font-semibold">
